...
//				Logic
void Round_Bush_Map::insert(my_key key,my_value value, _tr_int translat_int)
{
	// O(f)
	...
	this->_main_array[tmp_index_arr][tmp_index_self].insert(key,value);
}

void Round_Bush_Map::remov(my_key key, _tr_int translat_int)
{
	// O(f)
	_int_crb tmp = translat_int % this->_model;
	_int_crb tmp_index_self = tmp % this->_len_bush_array;
	...
	this->_main_array[tmp_index_arr][tmp_index_self].remov(key);
}

bool Round_Bush_Map::search(my_key key, _tr_int translat_int)
{
	// O(f/mod)
	_int_crb tmp = translat_int % this->_model;
	_int_crb tmp_index_self = tmp % this->_len_bush_array;
	...
	return this->_main_array[tmp_index_arr][tmp_index_self].search(key);
}


//				Info
unsigned int Round_Bush_Map::size()
{
	this->_size = 0;
...
void Round_Bush_Map::print_debag()
{
	cout << "=============\n";
	for (_int_crb i = 0; i < this->_model / this->_len_bush_array; i++)
	{
...
void Round_Bush_Map::print_array()
{
	for (_int_crb i = 0; i < this->_model / this->_len_bush_array; i++)
	{
		for (_int_crb z = 0; z < this->_len_bush_array; z++) {
...
void Round_Bush_Map::get_sortArray_list(list<my_value>& res_array_list)
{
	for (_int_crb i = 0; i < this->_model / this->_len_bush_array; i++)
	{
		for (_int_crb z = 0; z < this->_len_bush_array; z++) {
...
//				Data
Round_Bush_Map::Round_Bush_Map(_int_crb model, _int_crb len_bush_array)
{
